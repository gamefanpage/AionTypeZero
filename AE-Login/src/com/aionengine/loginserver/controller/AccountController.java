...
import com.aionengine.loginserver.network.aion.serverpackets.SM_SERVER_LIST;
import com.aionengine.loginserver.network.aion.serverpackets.SM_UPDATE_SESSION;
import com.aionengine.loginserver.network.gameserver.GsConnection;
import com.aionengine.loginserver.network.gameserver.serverpackets.SM_ACCOUNT_AUTH_RESPONSE;
import com.aionengine.loginserver.network.gameserver.serverpackets.SM_GS_CHARACTER_RESPONSE;
import com.aionengine.loginserver.network.gameserver.serverpackets.SM_REQUEST_KICK_ACCOUNT;
import com.aionengine.loginserver.utils.AccountUtils;
...
public class AccountController {
	...
	public static synchronized void checkAuth(SessionKey key, GsConnection gsConnection) {
		...
		if (con != null && con.getSessionKey().checkSessionKey(key)) {
			...
			AccountToll toll = DAOManager.getDAO(PremiumDAO.class).getTolls(acc.getId());

			if (acc.getMembership() == null) {
				//DAOManager.getDAO(AccountDAO.class).insertAccountMemberShip(acc.getId());
				acc.setMemberShip(new AccountMembership());
			}
			/**
			...
			gsConnection.sendPacket(new SM_ACCOUNT_AUTH_RESPONSE(key.accountId, false, null, (byte) 0, null, null));
		}
	}
	 ...
	 * If success returns {@link com.aionengine.loginserver.network.aion.AionAuthResponse#AUTHED} and sets account object to connection.<br>
	 * If {@link com.aionengine.loginserver.configs.Config#ACCOUNT_AUTO_CREATION} is enabled - creates new account.<br>
	 *
	...
	public static Account createAccount(String name, String password) {
		...
		account.setMemberShip(new AccountMembership());
	...
	/**
	 * Returns {@link com.aionengine.loginserver.dao.AccountDAO}, just a shortcut
	 *
	 * @return {@link com.aionengine.loginserver.dao.AccountDAO}
	 */
	...
	/**
	 * Returns {@link com.aionengine.loginserver.dao.AccountTimeDAO}, just a shortcut
	 *
	 * @return {@link com.aionengine.loginserver.dao.AccountTimeDAO}
	 */
