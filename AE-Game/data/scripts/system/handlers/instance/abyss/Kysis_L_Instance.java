...
public class Kysis_L_Instance extends GeneralInstanceHandler {
	...
	public void onInstanceCreate(WorldMapInstance instance) {
		...
		spawn(spawn_point6 == 1 ? 235537 : 832865, 552.80597f, 575.031f, 176.89429f, (byte) 60);
		...
		spawn(spawn_legion_point2 == 1 ? 235537 : 832865, 437.78436f, 432.13367f, 197.20628f, (byte) 60);
		...
		spawn(spawn_legion_point5 == 1 ? 235537 : 832865, 506.79877f, 441.54056f, 180.94101f, (byte) 90);
		int spawn_legion_point6 = Rnd.get(1, 2);
		spawn(spawn_legion_point6 == 1 ? 235537 : 832865, 498.29544f, 575.58014f, 176.89429f, (byte) 0);
		...
		spawn(spawn_legion_point9 == 1 ? 235537 : 832865, 615.80884f, 270.33264f, 191.78235f, (byte) 90);
	}
	...
	private void spawnChests(Npc npc) {
		if(!rewarded) {
			...
			if (npc.getAi2().getRemainigTime() != 0) {
				...
				spawn(702034, 478.7917f, 815.5538f, 199.70894f, (byte) 9);
				if (rtime > 1)
					spawn(702034, 471, 853, 199f, (byte) 117);
				if (rtime > 2)
					spawn(702034, 477, 873, 199.7f, (byte) 109);
				if (rtime > 3)
					spawn(702034, 507, 899, 199.7f, (byte) 96);
				if (rtime > 4)
					spawn(702034, 548, 901, 199.7f, (byte) 83);
				if (rtime > 5)
					spawn(702034, 565, 889, 199.7f, (byte) 76);
				if (rtime > 6)
					spawn(702034, 585, 855, 199.7f, (byte) 65);
				if (rtime > 7)
					spawn(702034, 578, 874, 199.7f, (byte) 9);
				if (rtime > 8)
					spawn(702034, 528, 903, 199.7f, (byte) 30);
				if (rtime > 9)
					spawn(702034, 490, 899, 199.7f, (byte) 44);
				if (rtime > 10)
					spawn(702034, 470, 834, 199.7f, (byte) 63);
				if (rtime > 11 && npc.getNpcId() == 233676)
					spawn(702035, 577.5694f, 836.9684f, 199.7f, (byte) 120); //last chest only for big boss
			}
		}
	}
