...
public class SteelRoseQuartersGroupInstance extends GeneralInstanceHandler {
	...
	public void onInstanceCreate(WorldMapInstance instance) {
		...
		if (Rnd.get(1, 2) == 1) {
			spawn(230725, 745.5443f, 457.9260f, 942.3539f, (byte) 60);
		}
		else {
			spawn(230725, 728.008f, 541.524f, 942.354f, (byte) 60);
		}
	  }
	...
	public void handleUseItemFinish(Player player, Npc npc) {
		switch (npc.getNpcId()) {
	  case 730764:
		 TeleportService2.teleportTo(player, 301040000, 702.97f, 500.75f, 939.62f, (byte) 119, TeleportAnimation.BEAM_ANIMATION);
		 break;
            }
	}
