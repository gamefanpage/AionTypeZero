 ...
 * @author Romanz
 */
@AIName("7011_mercenary_ely")
public class MercenaryElyos_7011AI2 extends NpcAI2 {
    ...
    private void checkEntryConditions(Player player, int dialogId, int questId) {
        if (dialogId == 10000) {
            if (player.getInventory().getItemCountByItemId(186000236) >= 12) {
                if ((getPosition().getWorldMapInstance().getNpc(881596)  == null) &&
                player.getInventory().decreaseByItemId(186000236, 12)) {
                spawn(881596, 846.1f, 310.01f, 150.94f, (byte) 0); // Ra
                spawn(881596, 846.1f, 306.01f, 150.94f, (byte) 0); // Ra
                spawn(881596, 781.6f, 345.08f, 153.7f, (byte) 30); // Ra
                spawn(881596, 835.02f, 334.4f, 150.94f, (byte) 30); // Ra
                spawn(881596, 839.1f, 332.01f, 150.94f, (byte) 30); // Ra
                spawn(881596, 792.03f, 344.96f, 153.7f, (byte) 30); // Ra
            ...
            if (player.getInventory().getItemCountByItemId(186000236) >= 12) {
                if ((getPosition().getWorldMapInstance().getNpc(882293)  == null) &&
                player.getInventory().decreaseByItemId(186000236, 12)) {
                spawn(882293, 839.74f, 353.79f, 142.19f, (byte) 0); // trap
                spawn(882293, 863.15f, 336.27f, 141.94f, (byte) 0); // trap
                spawn(882293, 710.87f, 336.48f, 141.94f, (byte) 0); // trap
                spawn(882293, 734.72f, 353.71f, 142.19f, (byte) 35); // trap
    ...
    protected void handleDespawned() {
        ...
        deleteMobs(instance.getNpcs(881596));
        deleteMobs(instance.getNpcs(882293));
