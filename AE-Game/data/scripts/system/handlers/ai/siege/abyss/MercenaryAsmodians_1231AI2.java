 ...
 * @author Romanz
 */
@AIName("1231_mercenary_asmo")
public class MercenaryAsmodians_1231AI2 extends NpcAI2 {
    ...
    private void checkEntryConditions(Player player, int dialogId, int questId) {
        if (dialogId == 10000) {
            if (player.getInventory().getItemCountByItemId(186000236) >= 6) {
                if ((getPosition().getWorldMapInstance().getNpc(251755) == null &&
                getPosition().getWorldMapInstance().getNpc(251756)  == null) &&
                player.getInventory().decreaseByItemId(186000236, 6)) {
                spawn(251755, 2441.022f, 2107.01f, 3058.5696f, (byte) 60); // tu
                spawn(251756, 2567.915f, 2123.672f, 3058.5918f, (byte) 0); // Tu
            ...
            if (player.getInventory().getItemCountByItemId(186000236) >= 6) {
                if ((getPosition().getWorldMapInstance().getNpc(251757) == null &&
                getPosition().getWorldMapInstance().getNpc(251758)  == null) &&
                player.getInventory().decreaseByItemId(186000236, 6)) {
                spawn(251757, 2385.6816f, 2106.9275f, 3050.569f, (byte) 60); // Tu
                spawn(251758, 2619.3218f, 2121.616f, 3043.801f, (byte) 90); // Tu
            ...
            if (player.getInventory().getItemCountByItemId(186000236) >= 3) {
                if ((getPosition().getWorldMapInstance().getNpc(251759) == null) &&
                player.getInventory().decreaseByItemId(186000236, 3)) {
                spawn(251759, 2505.924f, 2108.7202f, 3073.0066f, (byte) 60); // Tu
    ...
    protected void handleDespawned() {
        ...
        deleteMobs(instance.getNpcs(251755));
        deleteMobs(instance.getNpcs(251756));
        deleteMobs(instance.getNpcs(251757));
        deleteMobs(instance.getNpcs(251758));
        deleteMobs(instance.getNpcs(251759));
