 ...
 * @author Romanz
 */
@AIName("1241_mercenary_asmo")
public class MercenaryAsmodians_1241AI2 extends NpcAI2 {
    ...
    private void checkEntryConditions(Player player, int dialogId, int questId) {
        if (dialogId == 10000) {
            if (player.getInventory().getItemCountByItemId(186000236) >= 6) {
                if ((getPosition().getWorldMapInstance().getNpc(251775) == null &&
				getPosition().getWorldMapInstance().getNpc(251776) == null) &&
                player.getInventory().decreaseByItemId(186000236, 6)) {
                spawn(251775, 1802.836f, 2221.384f, 2958.2725f, (byte) 96); // tu
                spawn(251776, 1762.7878f, 2342.0156f, 2958.2947f, (byte) 36); // Tu
    ...
    protected void handleDespawned() {
        ...
        deleteMobs(instance.getNpcs(251775));
        deleteMobs(instance.getNpcs(251776));
