 ...
 * @author Romanz
 */
@AIName("1011_mercenary_asmo")
public class MercenaryAsmodians_1011AI2 extends NpcAI2 {
    ...
    private void checkEntryConditions(Player player, int dialogId, int questId) {
        if (dialogId == 10000) {
            if (player.getInventory().getItemCountByItemId(186000236) >= 36) {
                if ((getPosition().getWorldMapInstance().getNpc(881545)  == null) &&
                player.getInventory().decreaseByItemId(186000236, 36)) {
                spawn(881545, 2125.46f, 2004.37f, 2319.58f, (byte) 0); // Ra
                spawn(881545, 2144.86f, 1840.35f, 2327.47f, (byte) 60); // Ra
                spawn(881545, 2151.03f, 2004.39f, 2319.67f, (byte) 60); // Ra
                spawn(881545, 2144.87f, 1843.85f, 2328.33f, (byte) 60); // Ra
                spawn(881545, 2131.6f, 1857.71f, 2331.1f, (byte) 0); // Ra
                spawn(881545, 2131.67f, 1854.52f, 2330.34f, (byte) 0); // Ra
                spawn(881545, 2125.27f, 1948.82f, 2322.07f, (byte) 0); // Ra
            ...
            if (player.getInventory().getItemCountByItemId(186000236) >= 36) {
                if ((getPosition().getWorldMapInstance().getNpc(881543)  == null) &&
                player.getInventory().decreaseByItemId(186000236, 36)) {
                spawn(881543, 2129.17f, 1950.92f, 2322.07f, (byte) 30); // fi
                spawn(881543, 2126.45f, 1950.81f, 2322.07f, (byte) 30); // fi
                spawn(881543, 2148.93f, 2008.82f, 2320.15f, (byte) 60); // fi
                spawn(881543, 2152.6f, 2008.77f, 2320.16f, (byte) 60); // fi
                spawn(881543, 2139.33f, 1847.21f, 2316.06f, (byte) 30); // fi
                spawn(881543, 2136.29f, 1847.52f, 2316.17f, (byte) 30); // fi
                spawn(881543, 2123.36f, 2008.96f, 2320.16f, (byte) 0); // fi
                spawn(881543, 2127.03f, 2008.83f, 2320.15f, (byte) 35); // fi
    ...
    protected void handleDespawned() {
        ...
        deleteMobs(instance.getNpcs(881543));
        deleteMobs(instance.getNpcs(881545));
