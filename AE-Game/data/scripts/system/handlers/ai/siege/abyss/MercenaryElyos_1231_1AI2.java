 ...
 * @author Romanz
 */
@AIName("1231_mercenary_ely_1")
public class MercenaryElyos_1231_1AI2 extends NpcAI2 {
    ...
    private void checkEntryConditions(Player player, int dialogId, int questId) {
        if (dialogId == 10000) {
            if (player.getInventory().getItemCountByItemId(186000236) >= 4) {
                if ((getPosition().getWorldMapInstance().getNpc(251592)  == null) &&
                player.getInventory().decreaseByItemId(186000236, 4)) {
                spawn(251592, 2508.17f, 2050.55f, 3057.82f, (byte) 90); // Ra
                spawn(251592, 2519.13f, 2051.97f, 3057.82f, (byte) 90); // Ra
                spawn(251592, 2560.28f, 2115.09f, 3063.47f, (byte) 0); // Ra
            ...
            if (player.getInventory().getItemCountByItemId(186000236) >= 4) {
                if ((getPosition().getWorldMapInstance().getNpc(279986)  == null) &&
                player.getInventory().decreaseByItemId(186000236, 4)) {
                spawn(279986, 2451.34f, 2101.07f, 3063.3f, (byte) 65); // Ra
                spawn(279986, 2504.05f, 2165.52f, 3059.33f, (byte) 30); // Ra
                spawn(279986, 2493.65f, 2164.25f, 3059.33f, (byte) 30); // Ra
            ...
            if (player.getInventory().getItemCountByItemId(186000236) >= 12) {
                if ((getPosition().getWorldMapInstance().getNpc(279987)  == null) &&
                player.getInventory().decreaseByItemId(186000236, 12)) {
                spawn(279987, 2504.3f, 2120.67f, 3072.9f, (byte) 30); // Ra
                spawn(279987, 2506.96f, 2094.92f, 3072.9f, (byte) 90); // Ra
                spawn(279987, 2512.82f, 2106.71f, 3042.66f, (byte) 65); // Ra
                spawn(279987, 2512.85f, 2110.91f, 3042.7f, (byte) 65); // Ra
    ...
    protected void handleDespawned() {
        ...
        deleteMobs(instance.getNpcs(251592));
        deleteMobs(instance.getNpcs(279986));
        deleteMobs(instance.getNpcs(279987));
