 ...
 * @author Romanz
 */
@AIName("1221_mercenary_asmo_1")
public class MercenaryAsmodians_1221_1AI2 extends NpcAI2 {
    ...
    private void checkEntryConditions(Player player, int dialogId, int questId) {
        if (dialogId == 10000) {
            if (player.getInventory().getItemCountByItemId(186000236) >= 4) {
                if ((getPosition().getWorldMapInstance().getNpc(251589)  == null) &&
                player.getInventory().decreaseByItemId(186000236, 4)) {
                spawn(251589, 2072.62f, 1372.4f, 2974.65f, (byte) 65); // Ra
                spawn(251589, 2037.37f, 1370.13f, 2976.16f, (byte) 105); // Ra
                spawn(251589, 2038.95f, 1378.1f, 2976.02f, (byte) 110); // Ra
            ...
            if (player.getInventory().getItemCountByItemId(186000236) >= 4) {
                if ((getPosition().getWorldMapInstance().getNpc(251048)  == null) &&
                player.getInventory().decreaseByItemId(186000236, 4)) {
                spawn(251048, 2146.29f, 1281.95f, 2979.65f, (byte) 45); // Ra
                spawn(251048, 2058.42f, 1218.75f, 2977.01f, (byte) 90); // Ra
                spawn(251048, 1970.65f, 1264.15f, 2979.65f, (byte) 60); // Ra
            ...
            if (player.getInventory().getItemCountByItemId(186000236) >= 12) {
                if ((getPosition().getWorldMapInstance().getNpc(251049)  == null) &&
                player.getInventory().decreaseByItemId(186000236, 12)) {
                spawn(251049, 2069.03f, 1274.69f, 2986.47f, (byte) 0); // Ra
                spawn(251049, 2043.69f, 1273.73f, 2986.47f, (byte) 0); // Ra
                spawn(251049, 2059.28f, 1264.79f, 2956.27f, (byte) 35); // Ra
                spawn(251049, 2055.36f, 1264.79f, 2956.27f, (byte) 0); // Ra
    ...
    protected void handleDespawned() {
        ...
        deleteMobs(instance.getNpcs(251589));
        deleteMobs(instance.getNpcs(251048));
        deleteMobs(instance.getNpcs(251049));
