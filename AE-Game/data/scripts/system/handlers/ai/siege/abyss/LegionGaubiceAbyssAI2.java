...
@AIName("legion_gaubice_abyss")
public class LegionGaubiceAbyssAI2 extends ActionItemNpcAI2 {
	...
	public void handleUseItemFinish(Player player) {
		  ...
		  switch (player.getRace()) {
			case ELYOS:
		  SkillEngine.getInstance().applyEffectDirectly(21787, player, player, 3600000);
		  break;
			case ASMODIANS:
		  SkillEngine.getInstance().applyEffectDirectly(21788, player, player, 3600000);
		  break;
		  }
