 ...
 * @author Romanz
 */
@AIName("1221_mercenary_asmo")
public class MercenaryAsmodians_1221AI2 extends NpcAI2 {
    ...
    private void checkEntryConditions(Player player, int dialogId, int questId) {
        if (dialogId == 10000) {
            if (player.getInventory().getItemCountByItemId(186000236) >= 6) {
                if ((getPosition().getWorldMapInstance().getNpc(251740) == null &&
                getPosition().getWorldMapInstance().getNpc(251741)  == null) &&
                player.getInventory().decreaseByItemId(186000236, 6)) {
                spawn(251740, 2076.576f, 1369.829f, 2974.634f, (byte) 20); // tu
                spawn(251741, 2036.2f, 1374.35f, 2976.11f, (byte) 40); // Tu
            ...
            if (player.getInventory().getItemCountByItemId(186000236) >= 6) {
                if ((getPosition().getWorldMapInstance().getNpc(251736) == null &&
                getPosition().getWorldMapInstance().getNpc(251738)  == null) &&
                player.getInventory().decreaseByItemId(186000236, 6)) {
                spawn(251736, 2062.79f, 1339.068f, 2972.1404f, (byte) 30); // Tu
                spawn(251738, 1975.889f, 1264.689f, 2979.6551f, (byte) 90); // Tu
            ...
            if (player.getInventory().getItemCountByItemId(186000236) >= 9) {
                if ((getPosition().getWorldMapInstance().getNpc(251737) == null &&
                getPosition().getWorldMapInstance().getNpc(251739)  == null) &&
                player.getInventory().decreaseByItemId(186000236, 9)) {
                spawn(251737, 2058.28f, 1274.309f, 2986.5774f, (byte) 90); // Tu
                spawn(251739, 2150.923f, 1278.25f, 2979.655f, (byte) 15); // Tu
    ...
    protected void handleDespawned() {
        ...
        deleteMobs(instance.getNpcs(251736));
        deleteMobs(instance.getNpcs(251737));
        deleteMobs(instance.getNpcs(251738));
        deleteMobs(instance.getNpcs(251739));
        deleteMobs(instance.getNpcs(251740));
        deleteMobs(instance.getNpcs(251741));
