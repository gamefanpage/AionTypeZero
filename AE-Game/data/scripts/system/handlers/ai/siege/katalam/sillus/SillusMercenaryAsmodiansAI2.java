...
public class SillusMercenaryAsmodiansAI2 extends NpcAI2 {
    ...
    private void checkEntryConditions(Player player, int dialogId, int questId) {
        if (dialogId == 10000) {
            if (player.getInventory().getItemCountByItemId(186000236) >= 16) {
                if ((getPosition().getWorldMapInstance().getNpc(272152) == null &&
                getPosition().getWorldMapInstance().getNpc(272144)  == null) &&
                player.getInventory().decreaseByItemId(186000236, 16)) {
                spawn(272152, 1998.688f, 1799.0376f, 331.733f, (byte) 90); // Archer
                spawn(272152, 2101.2119f, 1870.0081f, 331.733f, (byte) 105); // Archer
                spawn(272152, 2165.853f, 1855.36f, 315.46f, (byte) 30); // Archer
                spawn(272152, 2000.1692f, 1722.8898f, 318.268f, (byte) 0); // Archer
                spawn(272152, 2000.1825f, 1725.9467f, 318.268f, (byte) 0); // Archer
                spawn(272152, 2007.1035f, 1801.4924f, 331.733f, (byte) 90); // Archer
                spawn(272152, 2105.3423f, 1875.0712f, 331.733f, (byte) 105); // Archer
                spawn(272144, 2201.9319f, 1870.5378f, 288.83f, (byte) 105); // Fisher
                spawn(272144, 2199.9441f, 1868.1339f, 288.43f, (byte) 105); // Fisher
                spawn(272144, 2025.4611f, 1722.5242f, 307.8534f, (byte) 105); // Fisher
                spawn(272144, 2018.953f, 1722.464f, 307.645f, (byte) 105); // Fisher
            ...
            if (player.getInventory().getItemCountByItemId(186000236) >= 8) {
                if ((getPosition().getWorldMapInstance().getNpc(272166) == null) &&
                player.getInventory().decreaseByItemId(186000236, 8)) {
                spawn(272166, 2014.9697f, 1794.6371f, 331.7571f, (byte) 60); // Archmagus
                spawn(272166, 1995.3406f, 1790.2651f, 332.03f, (byte) 15); // Archmagus
                spawn(272166, 2115.437f, 1876.0839f, 332.05f, (byte) 80); // Archmagus
                spawn(272166, 2101.9697f, 1861.1672f, 332.03f, (byte) 30); // Archmagus
            ...
            if (player.getInventory().getItemCountByItemId(186000236) >= 16) {
                if ((getPosition().getWorldMapInstance().getNpc(272159) == null) &&
                player.getInventory().decreaseByItemId(186000236, 16)) {
                spawn(272159, 2001.835f, 1799.8464f, 331.733f, (byte) 60); // Sniper
                spawn(272159, 2161.5847f, 1875.2308f, 311.008f, (byte) 60); // Sniper
                spawn(272159, 2003.9126f, 1800.4058f, 331.733f, (byte) 60); // Sniper
                spawn(272159, 2162.4954f, 1878.149f, 311.008f, (byte) 60); // Sniper
                spawn(272159, 2103.9932f, 1873.4806f, 331.733f, (byte) 60); // Sniper
                spawn(272159, 2041.8623f, 1724.8845f, 318.548f, (byte) 60); // Sniper
                spawn(272159, 2042.1536f, 1721.9293f, 318.548f, (byte) 60); // Sniper
                spawn(272159, 2167.4968f, 1853.9686f, 315.46f, (byte) 15); // Sniper
    ...
    protected void handleDespawned() {
        ...
        deleteMobs(instance.getNpcs(272152));
        deleteMobs(instance.getNpcs(272144));
        deleteMobs(instance.getNpcs(272166));
        deleteMobs(instance.getNpcs(272159));
