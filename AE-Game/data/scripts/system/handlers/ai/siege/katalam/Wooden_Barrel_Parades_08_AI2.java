...
@AIName("wooden_barrel_parades_08")
public class Wooden_Barrel_Parades_08_AI2 extends GeneralNpcAI2 {
	...
	private void BoxActive() {
		Npc boxBomb = getPosition().getWorldMapInstance().getNpc(701716);
