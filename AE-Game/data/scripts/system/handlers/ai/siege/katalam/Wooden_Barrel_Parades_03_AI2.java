...
@AIName("wooden_barrel_parades_03")
public class Wooden_Barrel_Parades_03_AI2 extends GeneralNpcAI2 {
	...
	private void BoxActive() {
		Npc boxBomb = getPosition().getWorldMapInstance().getNpc(701711);
