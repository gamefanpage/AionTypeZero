...
@AIName("wooden_barrel_parades_05")
public class Wooden_Barrel_Parades_05_AI2 extends GeneralNpcAI2 {
	...
	private void BoxActive() {
		Npc boxBomb = getPosition().getWorldMapInstance().getNpc(701713);
