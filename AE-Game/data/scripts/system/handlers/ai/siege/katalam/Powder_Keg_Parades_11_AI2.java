...
@AIName("power_keg_parades_11")
public class Powder_Keg_Parades_11_AI2 extends GeneralNpcAI2 {
	...
	private void BigBoxActive() {
		Npc boxBigBomb = getPosition().getWorldMapInstance().getNpc(701719);
	...
	private void Message() {
		World.getInstance().doOnAllPlayers(new Visitor<Player>() {
			...
			public void visit(Player player) {
				PacketSendUtility.sendPacket(player, new SM_SYSTEM_MESSAGE(1401692));
			}
		});
	}
}
