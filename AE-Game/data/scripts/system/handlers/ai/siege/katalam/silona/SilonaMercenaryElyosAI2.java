...
public class SilonaMercenaryElyosAI2 extends NpcAI2 {
    ...
    private void checkEntryConditions(Player player, int dialogId, int questId) {
        if (dialogId == 10000) {
            if (player.getInventory().getItemCountByItemId(186000236) >= 14) {
                if ((getPosition().getWorldMapInstance().getNpc(272576) == null) &&
            ...
            if (player.getInventory().getItemCountByItemId(186000236) >= 10) {
                if ((getPosition().getWorldMapInstance().getNpc(272586) == null) &&
            ...
            if (player.getInventory().getItemCountByItemId(186000236) >= 10) {
                if ((getPosition().getWorldMapInstance().getNpc(272837) == null) &&
                player.getInventory().decreaseByItemId(186000236, 10)) {
    ...
    protected void handleDespawned() {
        ...
        deleteMobs(instance.getNpcs(272820));
        deleteMobs(instance.getNpcs(272576));
        deleteMobs(instance.getNpcs(272586));
        deleteMobs(instance.getNpcs(272837));
