...
@AIName("wooden_barrel_parades_07")
public class Wooden_Barrel_Parades_07_AI2 extends GeneralNpcAI2 {
	...
	private void BoxActive() {
		Npc boxBomb = getPosition().getWorldMapInstance().getNpc(701715);
