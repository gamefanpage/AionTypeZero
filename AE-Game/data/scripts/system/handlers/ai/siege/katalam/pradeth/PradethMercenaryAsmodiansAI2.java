...
public class PradethMercenaryAsmodiansAI2 extends NpcAI2 {
    ...
    private void checkEntryConditions(Player player, int dialogId, int questId) {
        if (dialogId == 10000) {
            if (player.getInventory().getItemCountByItemId(186000236) >= 12) {
                if ((getPosition().getWorldMapInstance().getNpc(273096) == null &&
                getPosition().getWorldMapInstance().getNpc(273126) == null &&
                getPosition().getWorldMapInstance().getNpc(273111)  == null) &&
            ...
            if (player.getInventory().getItemCountByItemId(186000236) >= 20) {
                if ((getPosition().getWorldMapInstance().getNpc(273116) == null) &&
                player.getInventory().decreaseByItemId(186000236, 20)) {
                spawn(273116, 2667.2795f, 2592.56f, 268.32513f, (byte) 106); // Sniper
                spawn(273116, 2629.799f, 2770.936f, 265.8121f, (byte) 45); // Sniper
                spawn(273116, 2579.392f, 2672.4946f, 265.81476f, (byte) 75); // Sniper
                spawn(273116, 2621.6184f, 2632.5005f, 265.81476f, (byte) 76); // Sniper
                spawn(273116, 2736.454f, 2669.858f, 265.80414f, (byte) 106); // Sniper
                spawn(273116, 2775.1433f, 2654.893f, 262.82587f, (byte) 106); // Sniper
                spawn(273116, 2684.618f, 2557.8318f, 262.82587f, (byte) 106); // Sniper
                spawn(273116, 2627.3955f, 2578.351f, 262.82587f, (byte) 76); // Sniper
                spawn(273116, 2522.8257f, 2675.4504f, 262.82587f, (byte) 76); // Sniper
                spawn(273116, 2522.1343f, 2711.6804f, 262.82587f, (byte) 47); // Sniper
                spawn(273116, 2541.5078f, 2731.549f, 259.10098f, (byte) 41); // Sniper
                spawn(273116, 2632.497f, 2829.7847f, 262.82587f, (byte) 46); // Sniper
    ...
    protected void handleDespawned() {
        ...
        deleteMobs(instance.getNpcs(273316));
        deleteMobs(instance.getNpcs(273096));
        deleteMobs(instance.getNpcs(273126));
        deleteMobs(instance.getNpcs(273111));
        deleteMobs(instance.getNpcs(273116));
