...
@AIName("wooden_barrel_parades_01")
public class Wooden_Barrel_Parades_01_AI2 extends GeneralNpcAI2 {
	...
	private void BoxActive() {
		Npc boxBomb = getPosition().getWorldMapInstance().getNpc(701709);
