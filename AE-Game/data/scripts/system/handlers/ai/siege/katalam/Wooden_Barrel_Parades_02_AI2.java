...
@AIName("wooden_barrel_parades_02")
public class Wooden_Barrel_Parades_02_AI2 extends GeneralNpcAI2 {
	...
	private void BoxActive() {
		Npc boxBomb = getPosition().getWorldMapInstance().getNpc(701710);
