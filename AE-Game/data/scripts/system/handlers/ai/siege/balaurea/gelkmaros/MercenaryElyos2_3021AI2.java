 ...
 * @author Romanz
 */
@AIName("3021_mercenary_ely2")
public class MercenaryElyos2_3021AI2 extends NpcAI2 {
    ...
    private void checkEntryConditions(Player player, int dialogId, int questId) {
        if (dialogId == 10000) {
            if (player.getInventory().getItemCountByItemId(186000236) >= 6) {
                if ((getPosition().getWorldMapInstance().getNpc(252379) == null) &&
                player.getInventory().decreaseByItemId(186000236, 6)) {
                spawn(252379, 1840.46f, 1180.51f, 333.04f, (byte) 90); // Ranger
                spawn(252379, 1918.8f, 1180.17f, 333.07f, (byte) 90); // Ranger
                spawn(252379, 1837.55f, 1116.68f, 335.5f, (byte) 30); // Ranger
                spawn(252379, 1941.98f, 1115.29f, 335.64f, (byte) 30); // Ranger
                spawn(252379, 1864.3f, 1141.69f, 334.78f, (byte) 30); // Ranger
                spawn(252379, 1936.68f, 1141.25f, 332.68f, (byte) 30); // Ranger
    ...
    protected void handleDespawned() {
        ...
        deleteMobs(instance.getNpcs(252379));
