 ...
 * @author Romanz
 */
@AIName("2011_mercenary_ely")
public class MercenaryElyos_2011AI2 extends NpcAI2 {
    ...
    private void checkEntryConditions(Player player, int dialogId, int questId) {
        if (dialogId == 10000) {
            if (player.getInventory().getItemCountByItemId(186000236) >= 11) {
                if ((getPosition().getWorldMapInstance().getNpc(252348) == null &&
                getPosition().getWorldMapInstance().getNpc(252350) == null &&
                getPosition().getWorldMapInstance().getNpc(252351) == null &&
                getPosition().getWorldMapInstance().getNpc(252352)  == null) &&
                player.getInventory().decreaseByItemId(186000236, 11)) {
                spawn(252348, 1802.73f, 2080.3f, 317.98f, (byte) 60); // Fisher
                spawn(252348, 1764.62f, 2111.22f, 321.58f, (byte) 100); // Fisher
                spawn(252348, 1737.91f, 2202.23f, 326.04f, (byte) 100); // Fisher
                spawn(252350, 1679.1f, 2121.11f, 320.83f, (byte) 100); // Wizard
                spawn(252350, 1777.73f, 2138.72f, 318.86f, (byte) 100); // Wizard
                spawn(252351, 1707.71f, 2116.01f, 318.86f, (byte) 100); // Priest
                spawn(252351, 1816.64f, 2143.01f, 321.01f, (byte) 60); // Priest
                spawn(252352, 1795.66f, 2171.61f, 320.83f, (byte) 60); // Assasin Hide
                spawn(252352, 1697.9f, 2176.25f, 324.22f, (byte) 0); // Assasin Hide
                spawn(252352, 1752.81f, 2064.32f, 318.01f, (byte) 0); // Assasin Hide
                spawn(252352, 1783.69f, 2226.84f, 324.99f, (byte) 90); // Assasin Hide
    ...
    protected void handleDespawned() {
        ...
        deleteMobs(instance.getNpcs(252348));
        deleteMobs(instance.getNpcs(252350));
        deleteMobs(instance.getNpcs(252351));
        deleteMobs(instance.getNpcs(252352));
