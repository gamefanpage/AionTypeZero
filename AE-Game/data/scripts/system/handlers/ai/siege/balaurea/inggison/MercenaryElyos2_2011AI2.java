 ...
 * @author Romanz
 */
@AIName("2011_mercenary_ely2")
public class MercenaryElyos2_2011AI2 extends NpcAI2 {
    ...
    private void checkEntryConditions(Player player, int dialogId, int questId) {
        if (dialogId == 10000) {
            if (player.getInventory().getItemCountByItemId(186000236) >= 6) {
                if ((getPosition().getWorldMapInstance().getNpc(252349) == null) &&
                player.getInventory().decreaseByItemId(186000236, 6)) {
                spawn(252349, 1772.39f, 2145.01f, 332.74f, (byte) 90); // Ranger
                spawn(252349, 1805.04f, 2117.35f, 331.01f, (byte) 35); // Ranger
                spawn(252349, 1723.21f, 2095.38f, 330.91f, (byte) 35); // Ranger
                spawn(252349, 1718.03f, 2155.6f, 333.66f, (byte) 96); // Ranger
                spawn(252349, 1790.27f, 2176.53f, 333.52f, (byte) 96); // Ranger
                spawn(252349, 1699.27f, 2123.05f, 330.85f, (byte) 96); // Ranger
    ...
    protected void handleDespawned() {
        ...
        deleteMobs(instance.getNpcs(252349));
