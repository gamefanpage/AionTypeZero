 ...
 * @author Romanz
 */
@AIName("2021_mercenary_ely")
public class MercenaryElyos_2021AI2 extends NpcAI2 {
    ...
    private void checkEntryConditions(Player player, int dialogId, int questId) {
        if (dialogId == 10000) {
            if (player.getInventory().getItemCountByItemId(186000236) >= 11) {
                if ((getPosition().getWorldMapInstance().getNpc(252358) == null &&
                getPosition().getWorldMapInstance().getNpc(252360) == null &&
                getPosition().getWorldMapInstance().getNpc(252361) == null &&
                getPosition().getWorldMapInstance().getNpc(252362)  == null) &&
                player.getInventory().decreaseByItemId(186000236, 11)) {
                spawn(252358, 832.67f, 1860.01f, 334.01f, (byte) 80); // Fisher
                spawn(252358, 871.25f, 1947.14f, 338.61f, (byte) 80); // Fisher
                spawn(252358, 833.43f, 1813.07f, 330.12f, (byte) 60); // Fisher
                spawn(252360, 861.06f, 1861.91f, 331.29f, (byte) 60); // Wizard
                spawn(252360, 773.83f, 1923.53f, 333.26f, (byte) 60); // Wizard
                spawn(252361, 794.15f, 1899.71f, 331.29f, (byte) 100); // Priest
                spawn(252361, 892.72f, 1851.14f, 333.44f, (byte) 60); // Priest
                spawn(252362, 822.45f, 1978.29f, 337.39f, (byte) 100); // Assasin Hide
                spawn(252362, 795.47f, 1831.08f, 330.12f, (byte) 100); // Assasin Hide
                spawn(252362, 895.34f, 1886.82f, 333.25f, (byte) 80); // Assasin Hide
                spawn(252362, 921.14f, 1936.07f, 337.42f, (byte) 80); // Assasin Hide
    ...
    protected void handleDespawned() {
        ...
        deleteMobs(instance.getNpcs(252358));
        deleteMobs(instance.getNpcs(252360));
        deleteMobs(instance.getNpcs(252361));
        deleteMobs(instance.getNpcs(252362));
