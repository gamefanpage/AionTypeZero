 ...
 * @author Romanz
 */
@AIName("3011_mercenary_ely2")
public class MercenaryElyos2_3011AI2 extends NpcAI2 {
    ...
    private void checkEntryConditions(Player player, int dialogId, int questId) {
        if (dialogId == 10000) {
            if (player.getInventory().getItemCountByItemId(186000236) >= 6) {
                if ((getPosition().getWorldMapInstance().getNpc(252369) == null) &&
                player.getInventory().decreaseByItemId(186000236, 6)) {
                spawn(252369, 1182.12f, 902.94f, 317.93f, (byte) 30); // Ranger
                spawn(252369, 1158.38f, 941.39f, 316.17f, (byte) 90); // Ranger
                spawn(252369, 1155.4f, 877.94f, 318.65f, (byte) 30); // Ranger
                spawn(252369, 1236.41f, 941.03f, 316.24f, (byte) 90); // Ranger
                spawn(252369, 1259.36f, 876.44f, 318.79f, (byte) 30); // Ranger
                spawn(252369, 1254.5f, 902.51f, 315.83f, (byte) 30); // Ranger
                PacketSendUtility.sendPacket(player, new SM_SYSTEM_MESSAGE(1402341));
                PacketSendUtility.sendPacket(player, new SM_SYSTEM_MESSAGE(1402332));
    ...
    protected void handleDespawned() {
        ...
        deleteMobs(instance.getNpcs(252369));
