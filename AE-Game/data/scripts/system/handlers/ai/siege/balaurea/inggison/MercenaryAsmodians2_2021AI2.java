 ...
 * @author Romanz
 */
@AIName("2021_mercenary_asmo2")
public class MercenaryAsmodians2_2021AI2 extends NpcAI2 {
    ...
    private void checkEntryConditions(Player player, int dialogId, int questId) {
        if (dialogId == 10000) {
            if (player.getInventory().getItemCountByItemId(186000236) >= 6) {
                if ((getPosition().getWorldMapInstance().getNpc(252364) == null) &&
                player.getInventory().decreaseByItemId(186000236, 6)) {
                spawn(252364, 817.61f, 1927.62f, 346.09f, (byte) 80); // Ranger
                spawn(252364, 795.53f, 1870.39f, 343.5f, (byte) 15); // Ranger
                spawn(252364, 795.19f, 1908.57f, 343.1f, (byte) 80); // Ranger
                spawn(252364, 861.67f, 1839.65f, 343.58f, (byte) 30); // Ranger
                spawn(252364, 860.73f, 1880.82f, 345.13f, (byte) 80); // Ranger
                spawn(252364, 896.5f, 1892.48f, 345.95f, (byte) 80); // Ranger
                PacketSendUtility.sendPacket(player, new SM_SYSTEM_MESSAGE(1402323));
                PacketSendUtility.sendPacket(player, new SM_SYSTEM_MESSAGE(1402314));
    ...
    protected void handleDespawned() {
        ...
        deleteMobs(instance.getNpcs(252364));
