 ...
 * @author Romanz
 */
@AIName("3011_mercenary_ely")
public class MercenaryElyos_3011AI2 extends NpcAI2 {
    ...
    private void checkEntryConditions(Player player, int dialogId, int questId) {
        if (dialogId == 10000) {
            if (player.getInventory().getItemCountByItemId(186000236) >= 11) {
                if ((getPosition().getWorldMapInstance().getNpc(252368) == null &&
                getPosition().getWorldMapInstance().getNpc(252370) == null &&
                getPosition().getWorldMapInstance().getNpc(252371) == null &&
                getPosition().getWorldMapInstance().getNpc(252372)  == null) &&
                player.getInventory().decreaseByItemId(186000236, 11)) {
                spawn(252368, 1198.61f, 934.51f, 306.71f, (byte) 30); // Fisher
                spawn(252368, 1177.47f, 976.17f, 304.43f, (byte) 30); // Fisher
                spawn(252368, 1196.95f, 839.46f, 311.07f, (byte) 30); // Fisher
                spawn(252370, 1177.97f, 927.86f, 303.99f, (byte) 90); // Wizard
                spawn(252370, 1277.72f, 898.48f, 305.96f, (byte) 20); // Wizard
                spawn(252371, 1247.41f, 912.53f, 303.99f, (byte) 60); // Priest
                spawn(252371, 1138.86f, 918.85f, 306.14f, (byte) 0); // Priest
                spawn(252372, 1245.23f, 834.91f, 310.16f, (byte) 48); // Assasin Hide
                spawn(252372, 1148.9f, 884.31f, 305.96f, (byte) 48); // Assasin Hide
                spawn(252372, 1220.46f, 976.04f, 303.62f, (byte) 48); // Assasin Hide
                spawn(252372, 1184.59f, 892.28f, 307.28f, (byte) 0); // Assasin Hide
                PacketSendUtility.sendPacket(player, new SM_SYSTEM_MESSAGE(1402341));
                PacketSendUtility.sendPacket(player, new SM_SYSTEM_MESSAGE(1402328));
    ...
    protected void handleDespawned() {
        ...
        deleteMobs(instance.getNpcs(252368));
        deleteMobs(instance.getNpcs(252370));
        deleteMobs(instance.getNpcs(252371));
        deleteMobs(instance.getNpcs(252372));
