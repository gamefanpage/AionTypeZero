 ...
 * @author Romanz
 */
@AIName("3021_mercenary_asmo")
public class MercenaryAsmodians_3021AI2 extends NpcAI2 {
    ...
    private void checkEntryConditions(Player player, int dialogId, int questId) {
        if (dialogId == 10000) {
            if (player.getInventory().getItemCountByItemId(186000236) >= 11) {
                if ((getPosition().getWorldMapInstance().getNpc(252383) == null &&
                getPosition().getWorldMapInstance().getNpc(252385) == null &&
                getPosition().getWorldMapInstance().getNpc(252386) == null &&
                getPosition().getWorldMapInstance().getNpc(252387)  == null) &&
                player.getInventory().decreaseByItemId(186000236, 11)) {
                spawn(252383, 1859.91f, 1215.13f, 320.67f, (byte) 30); // Fisher
                spawn(252383, 1880.83f, 1172.42f, 323.56f, (byte) 30); // Fisher
                spawn(252383, 1879.14f, 1078.2f, 327.87f, (byte) 30); // Fisher
                spawn(252385, 1879.14f, 1078.2f, 327.87f, (byte) 30); // Wizard
                spawn(252385, 1832.91f, 1088.64f, 326.19f, (byte) 30); // Wizard
                spawn(252386, 1929.61f, 1151.54f, 320.84f, (byte) 30); // Priest
                spawn(252386, 1820.8f, 1157.23f, 322.99f, (byte) 0); // Priest
                spawn(252387, 1831.09f, 1123.06f, 322.81f, (byte) 0); // Assasin Hide
                spawn(252387, 1901.85f, 1214.92f, 320.56f, (byte) 60); // Assasin Hide
                spawn(252387, 1927.77f, 1073.41f, 327.02f, (byte) 60); // Assasin Hide
                spawn(252387, 1854.31f, 1094.61f, 326.2f, (byte) 0); // Assasin Hide
    ...
    protected void handleDespawned() {
        ...
        deleteMobs(instance.getNpcs(252383));
        deleteMobs(instance.getNpcs(252385));
        deleteMobs(instance.getNpcs(252386));
        deleteMobs(instance.getNpcs(252387));
