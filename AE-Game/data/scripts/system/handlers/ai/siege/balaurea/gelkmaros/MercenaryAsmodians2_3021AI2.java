 ...
 * @author Romanz
 */
@AIName("3021_mercenary_asmo2")
public class MercenaryAsmodians2_3021AI2 extends NpcAI2 {
    ...
    private void checkEntryConditions(Player player, int dialogId, int questId) {
        if (dialogId == 10000) {
            if (player.getInventory().getItemCountByItemId(186000236) >= 6) {
                if ((getPosition().getWorldMapInstance().getNpc(252384) == null) &&
                player.getInventory().decreaseByItemId(186000236, 6)) {
                spawn(252384, 1840.46f, 1180.51f, 333.04f, (byte) 90); // Ranger
                spawn(252384, 1918.8f, 1180.17f, 333.07f, (byte) 90); // Ranger
                spawn(252384, 1837.55f, 1116.68f, 335.5f, (byte) 30); // Ranger
                spawn(252384, 1941.98f, 1115.29f, 335.64f, (byte) 30); // Ranger
                spawn(252384, 1864.3f, 1141.69f, 334.78f, (byte) 30); // Ranger
                spawn(252384, 1936.68f, 1141.25f, 332.68f, (byte) 30); // Ranger
                PacketSendUtility.sendPacket(player, new SM_SYSTEM_MESSAGE(1402359));
                PacketSendUtility.sendPacket(player, new SM_SYSTEM_MESSAGE(1402350));
    ...
    protected void handleDespawned() {
        ...
        deleteMobs(instance.getNpcs(252384));
