 ...
 * @author xXMashUpXx
 */
public class ElyChannel extends PlayerCommand {
    ...
    public void execute(Player player, String... params) {
        if (player.getRace() == Race.ELYOS && !player.isInPrison()) {
            ...
            if (params.length < 1) {
                PacketSendUtility.sendMessage(player, "\u0441\u0438\u043d\u0442\u0430\u043a\u0441\u0438\u0441 : .ely <\u0441\u043e\u043e\u0431\u0449\u0435\u043d\u0438\u0435>");
                return;
            }
            ...
            if (player.isGM()) {
                ...
                sbMessage = new StringBuilder("([color:\u042d\u043b\u0438\u0439;0 1 0][color:\u0446\u044b;0 1 0])" + " " + player.getName() + ": ");
            }
        	...
        	PacketSendUtility.sendMessage(player, "\u0412\u0430\u0448\u0430 \u0440\u0430\u0441\u0430 \u043d\u0435 \u043c\u043e\u0436\u0435\u0442 \u0438\u0441\u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0442\u044c \u044d\u0442\u043e\u0442 \u0447\u0430\u0442 . \u0418\u0441\u043f\u043e\u043b\u044c\u0437\u0443\u0439\u0442\u0435 .asmo");
        }
    }
