 ...
 * @author synchro2
 */
public class cometome extends PlayerCommand {
	...
	public void execute(final Player player, String... params) {
		...
		if(player.isInInstance()) {
			PacketSendUtility.sendMessage(player, "\u0412\u044b \u043d\u0435 \u043c\u043e\u0436\u0435\u0442\u0435 \u043f\u0440\u0438\u0437\u0432\u0430\u0442\u044c \u043f\u0430\u0440\u0442\u043d\u0435\u0440\u0430 " + partner.getName() +", \u0442\u0430\u043a \u043a\u0430\u043a \u0432\u044b \u043d\u0430\u0445\u043e\u0434\u0438\u0442\u0435\u0441\u044c \u0432 \u0434\u0430\u043d\u0436\u0435.");
			return;
		}
		...
		if(!player.isCommandInUse()) {
			...
			PacketSendUtility.sendMessage(player, partner.getName() + " \u043f\u0435\u0440\u0435\u043c\u0435\u0449\u0435\u043d(\u0430) \u043a \u0412\u0430\u043c.");
