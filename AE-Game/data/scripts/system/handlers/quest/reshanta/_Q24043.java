...
public class _Q24043 extends QuestHandler {
			...
			switch (targetId) {
				...
				case 279027: { // Kaoranerk
					switch (dialog) {
						...
						case SETPRO5: {
							TeleportService2.teleportTo(player, 120010000, 1368.7f, 1036.1f, 206.1f, (byte) 90, TeleportAnimation.BEAM_ANIMATION);
				...
				case 204210: { // Phosphor
					switch (dialog) {
						...
						case SETPRO6: {
							TeleportService2.teleportTo(player, 400010000, 870.9f, 3098.1f, 1643f, (byte) 30, TeleportAnimation.BEAM_ANIMATION);
