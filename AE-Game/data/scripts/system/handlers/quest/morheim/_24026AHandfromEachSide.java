...
public class _24026AHandfromEachSide extends QuestHandler {
	...
	public boolean onLvlUpEvent(QuestEnv env) {
		return defaultOnLvlUpEvent(env, 24025, true);
	}
			...
			switch (targetId) {
				case 204301: { // Aegir
					switch (env.getDialog()) {
						...
						case SETPRO1:
							TeleportService2.teleportTo(player, 220020000, 2795.72f, 481.3345f, 266f, (byte) 50, TeleportAnimation.BEAM_ANIMATION);
				...
				case 204403: { // Taisan
					switch (env.getDialog()) {
						...
						case SETPRO2:
							TeleportService2.teleportTo(player, 220020000, 3027.64f, 871.87f, 363f, (byte) 13, TeleportAnimation.BEAM_ANIMATION);
				...
				case 204432: { // Kargate
					switch (env.getDialog()) {
						...
						case SETPRO4:
							if (var == 4) {
								TeleportService2.teleportTo(player, 220020000, 228.45f, 2413.5f, 454f, (byte) 50, TeleportAnimation.BEAM_ANIMATION);
