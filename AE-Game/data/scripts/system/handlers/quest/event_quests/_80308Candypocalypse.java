...
public class _80308Candypocalypse extends QuestHandler {

    private final static int questId = 80308;

    public _80308Candypocalypse() {
        super(questId);
    }

    @Override
    public void register() {
        qe.registerQuestNpc(831399).addOnQuestStart(questId);
