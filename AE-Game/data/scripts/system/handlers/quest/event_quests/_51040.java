...
public class _51040 extends QuestHandler {

	private final static int questId = 51040;
	...
	public void register() {
		qe.registerQuestNpc(832816).addOnQuestStart(questId);
		qe.registerQuestNpc(832816).addOnTalkEvent(questId);
