...
public class _80309JustShovelIt extends QuestHandler {

    private final static int questId = 80309;

    public _80309JustShovelIt() {
        super(questId);
    }

    @Override
    public void register() {
        qe.registerQuestNpc(831401).addOnQuestStart(questId);
