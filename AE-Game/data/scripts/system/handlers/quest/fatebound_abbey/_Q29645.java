 ...
 *
 */
public class _Q29645 extends QuestHandler
{
	...
	public void register()
	{
		...
		qe.registerQuestNpc(219662).addOnKillEvent(questId);
		qe.registerQuestNpc(219663).addOnKillEvent(questId);
		qe.registerQuestNpc(219668).addOnKillEvent(questId);
	}
